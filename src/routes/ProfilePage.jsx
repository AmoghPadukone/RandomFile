...
import { BentoGrid, BentoGridItem } from "../components/Profile/BentoGrid";
...
export function ProfilePage() {
  return (
    <>
      ...
      <div className="h-[50rem] w-full bg-zinc-100 bg-grid-small-black/[0.2] relative flex items-center justify-center">
        {/* Radial gradient for the container to give a faded look */}
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-zinc-100 [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://media.licdn.com/dms/image/D5603AQEMrrZzlkFFmg/profile-displayphoto-shrink_800_800/0/1696515872802?e=1722470400&v=beta&t=X2kNo3bNGnoVDb3fVFCeIkiA1dQBrdebrTedtTeL9IY"
          alt="avatar"
          height="100"
          width="100"
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Understand the sentiment of me with my Skills.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  {
    title: "My Summarization",
    description: (
      <span className="text-sm">
        Summarizing my lengthy experience in short.
      </span>
    ),
    header: <SkeletonFive />,
